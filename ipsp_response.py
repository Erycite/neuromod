{
    ...
    'Injections' : {
        'cell' : {
            ...
            'amplitude' : [-.5, 0.0], # figure 1DEF
            'start' : [200., 1600.], # figure 1DEF
...
#                 'tau_refrac' : 2.5,   # ms, refractory period (ReinagelReid2000)
#                 'delta_T'    : 2.5,   # mV, steepness of exponential approach to threshold (Destexhe2009)
#                 'v_thresh'   : -55.0, # mV, fixed spike threshold
#                 'v_spike'    : -30.0, # mV, spike detection
#                 'v_rest'     : -63.0, # mV, resting potential (RE: ContrerasCurroSteriade1993; TC: McCormick1992, TurnerAndersonWilliamsCrunelli1997, Cerina et al. 2015); IN (PapeMcCormick1995)
#                 'tau_w'      : 270.0, # ms, time constant of adaptation variable (Cerina et al. 2015)
#                 'b'          : .02,  # nA, increment to the adaptation variable (Cerina et al. 2015)
...
#                 # RE - ContrerasCurroSteriade1993 cat in-vivo awake
#                 'v_reset'    : -50.0, # mV, reset after spike (Destexhe2009)
#                 'a'          : 18,    # nS, spike-frequency adaptation (Cerina et al. 2015)(McCormickHuguenrad1992: IKleak fig13)
#                 'cm'         : 0.480, # nF, tot membrane capacitance (Uhlrich Cucchiaro Humphrey Sherman 1991)
#                 'tau_m'      : 48.,  # ms, time constant of leak conductance (cm/gl, with gl=0.01)
